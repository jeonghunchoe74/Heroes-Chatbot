...
def format_output_html(label_ko: str) -> str:
    ...
    return f"""
    <div style="margin-top:20px;padding:10px 12px;background:#f7f9ff;
                border-radius:10px;border:1px solid #dbe4ff;
                font-size:13px;line-height:1.6;">
      <p style="margin:0;font-weight:600;">📊 섹터 : {label_ko}</p>
      <p style="margin:4px 0 0 0;"><strong>Top5 종목 :</strong> {name_list}</p>
    </div>
    """
