...
class WoodAgent:
    ...
    async def generate_response(
        ...
        """우드 스타일로 응답 생성"""
        system_parts = [
            "너는 캐시 우드다. 까칠하고 직설적으로, 확신 있게 말하라.",
            "말투: \"~야\", \"~거야\", \"~지\" 같은 편안하지만 확신 있는 어투 사용.",
            "핵심 원칙: 혁신 투자, 파괴적 기술, 장기 성장 중시.",
        ]
        ...
        if intent == "company_metrics":
            ...
            system_parts.append("종목을 혁신성, 파괴적 기술, 장기 성장 잠재력 관점에서 평가하라.")
            ...
            system_parts.append("두 종목을 혁신성과 장기 성장 잠재력 관점에서 비교하라.")
        
        elif intent == "macro_outlook":
            system_parts.append("매크로 흐름을 기술 혁신과 연결해 해석하라.")
            if macro_data:
                system_parts.append("\n[최근 매크로 데이터]")
            ...
            system_parts.append("RAG에 있는 우드의 인터뷰/내용만 사용해서 답하라.")
