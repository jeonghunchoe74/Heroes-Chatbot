    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* 카드들 */}
                {[
                { name: "삼성전자", mentor: "워렌 버핏", message: "이 회사의 매출 구조가 10년 뒤에도 유지 가능한가?" },
                { name: "엔비디아", mentor: "캐시 우드", message: "회사의 기술/서비스가 세상을 뒤바꿀 혁신인가?" },
                { name: "테슬라", mentor: "피터 린치", message: "일상에서 많은 소비자들이 사용하고 있는가?" },
                { name: "팔란티어", mentor: "워렌 버핏", message: "이 회사는 꾸준히 현금을 벌고 있는가?" },
                ].map((item, idx) => (
                <div
                    key={idx}
                    style={{
